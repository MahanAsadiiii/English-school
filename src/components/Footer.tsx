        ...
        <div className='mt-40'>
            ...
            <div className='flex flex-col items-center relative'>
                ...
                <nav className='flex justify-between basis-4/5'>
                    <a href="" className=' text-base font-normal text-[#363853] mx-5'>Home</a>
                    <a href="" className=' text-base font-normal text-[#363853] mx-5'>About Us</a>
                    <a href="" className=' text-base font-normal text-[#363853] mx-5'>How it Works</a>
                    <a href="" className=' text-base font-normal text-[#363853] mx-5'>Pricing</a>
                    <a href="" className=' text-base font-normal text-[#363853] mx-5'>Download app</a>
                </nav>
            </div>
            ...
            <div className="flex justify-between mt-6 mb-5">
                ...
                <span className='text-sm  text-[#363853]'>© Copyright 2021 by learn english. All rights reserved.</span>
            </div>
        </div>
    )
}
